	...
	public static void main(String[] args) {
		try {
			...
			BufferedReader reader = new BufferedReader(new FileReader(
					"/Users/pc/Downloads/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_business.json"));
			...
			reader = new BufferedReader(new FileReader(
					"/Users/pc/Downloads/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_review.json"));
